<div align="center">
  ...
  <br />
  <p>
    <a href="https://docs.memorose.dev"><b>文档</b></a> &nbsp;&bull;&nbsp;
  ...
  <p>
    <i>昔日的玫瑰以其名流传，今人所持唯玫瑰之名</i><br />
    <sub>—— Bernard of Cluny</sub>
  </p>
  <p><sub>Memorose 源于《玫瑰之名》，致力于构建分布式、多模态的长期记忆湖。我们希望打造最可靠、持续演变、持续进化且高度灵活的记忆基础设施。</sub></p>
  <br />
</div>
...
<table>
  <tr>
    <td valign="top" width="33%">
      ...
      <pre lang="bash"><code>docker run -d \
  --name memorose \
  -p 3000:3000 \
  -p 3100:3100 \
  ...
  dylan2024/memorose:latest</code></pre>
      <details>
...
| **L3** | `L3Task` 及目标型单元 | 面向未来的目标与任务记忆 | 目标结构、任务树、里程碑、依赖、执行状态 | 目标与任务系统 | 规划与执行协同 |
