...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/settings/", get(|| async { Redirect::temporary("/dashboard/en/settings/") }))
        // Handle internal dashboard redirects for missing locale prefixes
        .route("/dashboard", get(|| async { Redirect::temporary("/dashboard/en/login/") }))
        .route("/dashboard/login", get(|| async { Redirect::temporary("/dashboard/en/login/") }))
        .route("/dashboard/login/", get(|| async { Redirect::temporary("/dashboard/en/login/") }))
        .route("/dashboard/cluster", get(|| async { Redirect::temporary("/dashboard/en/cluster/") }))
        .route("/dashboard/cluster/", get(|| async { Redirect::temporary("/dashboard/en/cluster/") }))
        .route("/dashboard/memories", get(|| async { Redirect::temporary("/dashboard/en/memories/") }))
        .route("/dashboard/memories/", get(|| async { Redirect::temporary("/dashboard/en/memories/") }))
        .route("/dashboard/playground", get(|| async { Redirect::temporary("/dashboard/en/playground/") }))
        .route("/dashboard/playground/", get(|| async { Redirect::temporary("/dashboard/en/playground/") }))
        .route("/dashboard/apps", get(|| async { Redirect::temporary("/dashboard/en/apps/") }))
        .route("/dashboard/apps/", get(|| async { Redirect::temporary("/dashboard/en/apps/") }))
        .route("/dashboard/agents", get(|| async { Redirect::temporary("/dashboard/en/agents/") }))
        .route("/dashboard/agents/", get(|| async { Redirect::temporary("/dashboard/en/agents/") }))
        .route("/dashboard/metrics", get(|| async { Redirect::temporary("/dashboard/en/metrics/") }))
        .route("/dashboard/metrics/", get(|| async { Redirect::temporary("/dashboard/en/metrics/") }))
